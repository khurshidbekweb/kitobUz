            ...
            <ul className="cards mt-10 flex gap-5">
              <li className="card border-2 rounded-xl ">
                ...
                <div className="px-5 flex flex-col gap-2 mt-3 mb-2">
                  ...
                  <p className="opacity-50 font-medium text-lg">Abu Homid G’azzoliy</p>
                  <a href="#" className="text-blue-500">Vaqtincha Almashtiraman</a>
                  <p className="">Holati: <span className="font-medium">O’rtacha</span></p>
                </div>
              </li>
              <li className="card border-2 rounded-xl ">
                <img src={bookImg} alt="book image" />
